...
const MUSCLE_ZONE_PATHS: Partial<Record<PilotMuscleRegionId, MuscleMapSpec>> = {
  ...
  "calf-anterior": {
    ...
    imageWidth: 1024,
    imageHeight: 1536,
    // 胫骨前肌肌腹限于小腿上 1/2～2/3；下段为肌腱移行与胫骨嵴骨面，不画入。
    path: "M326 758 C344 744 366 746 379 765 C386 812 383 864 378 919 C375 954 369 992 359 1016 C353 1029 345 1031 340 1022 C332 1006 330 970 329 933 C326 878 318 808 326 758 Z",
    assetReviewStatus: "reviewed",
    overlayReviewStatus: "pending",
  },
  "calf-posterior": {
    ...
    path: "M553 762 C583 730 680 728 714 760 C739 797 742 851 731 909 C725 949 717 992 708 1024 C699 1051 683 1068 662 1070 C641 1068 630 1050 622 1026 C612 996 596 975 581 961 C562 905 538 821 553 762 Z",
    assetReviewStatus: "reviewed",
    overlayReviewStatus: "pending",
  },
  "calf-lateral": {
