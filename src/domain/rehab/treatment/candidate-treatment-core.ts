...
export function candidateMuscleFocus(candidate: CandidateTreatmentInput) {
  ...
  const siteRules: Array<[RegExp, string, string]> = [
    ...
    [/大腿外侧/, "thigh-lateral", "大腿外侧链"], [/大腿内侧/, "thigh-medial", "大腿内侧肌群"],
    [/鹅足|膝内侧/, "knee-medial-soft-tissue", "膝内侧软组织"],
  ...
  const rules: Array<[RegExp, string, string]> = [
    ...
    [/大腿内侧|内收肌/, "thigh-medial", "大腿内侧肌群"],
    [/鹅足|缝匠肌|股薄肌|半腱肌/, "knee-medial-soft-tissue", "膝内侧鹅足相关软组织"],
