...
const knee: FullRegion = {
  ...
  strengths: [
    strength("knee-quadriceps", assessmentPro("knee-quadriceps").title, assessmentPro("knee-quadriceps").how, assessmentPro("knee-quadriceps").observe, ["quadriceps", "terminal-extension"]),
    ...
    strength("knee-adductor-pes", assessmentPro("knee-adductor-pes").title, assessmentPro("knee-adductor-pes").how, assessmentPro("knee-adductor-pes").observe, ["adductor", "medial-knee"]),
    strength("knee-glute", assessmentPro("knee-glute").title, assessmentPro("knee-glute").how, assessmentPro("knee-glute").observe, ["glute", "pelvic-stability"]),
  ...
  candidateGroups: [
    {
      ...
      candidates: [
        candidate("knee-anterior-muscles", "大腿前外侧轻柔松解", "muscle", "self", "用手或泡沫轴轻柔放松大腿前侧和外侧，每个紧张区域60～90秒。", "避开髌腱、髌骨下方和明显刺痛点。", "重复原来的下蹲或台阶动作。", ["quadriceps", "lateral-chain", "anterior-knee"]),
    ...
    },
    {
      ...
      candidates: [
        candidate("knee-medial-lateral-chain", "大腿外侧轻柔松解", "muscle", "self", "用手或泡沫轴轻柔放松大腿外侧和髋外侧，每个紧张区域60～90秒。", "不沿髂胫束整条重压。", "重复原来的下楼或承重动作。", ["lateral-chain", "step-down"]),
        candidate("knee-medial-pes", "大腿内侧轻柔松解", "muscle", "self", "轻柔放松大腿内侧和内侧大腿后方，每个区域60～90秒。", "避开膝内下方的明确刺痛点，不反复重按。", "重复原来的下楼或承重动作。", ["pes-anserine", "adductor", "medial-hamstring"]),
        candidate("knee-medial-adductor", "大腿内收肌轻柔松解", "muscle", "self", "轻柔放松检查中更紧或更酸的大腿内收肌区域60～90秒。", "避开膝内侧明确刺痛点，不反复重按。", "重复原来的下楼或承重动作。", ["adductor", "medial-knee"]),
        candidate("knee-medial-foot", "足弓与踝部控制练习", "control", "self", "坐着或站着轻轻踮起脚尖再放下，做 5～8 次；再扶着固定物做 5～8 次膝盖向前小幅移动。", "脚跟不抬起，膝盖自然朝脚尖方向。", "重复原来的下楼或承重动作。", ["arch", "tibialis-posterior", "ankle"]),
    ...
    },
    {
      ...
      candidates: [
        candidate("knee-lateral-muscles", "大腿外侧与后外侧轻柔松解", "muscle", "self", "用手或泡沫轴轻柔放松大腿外侧和后外侧，每个紧张区域60～90秒。", "避开膝外侧骨点和腘窝，不直接重压疼痛中心。", "重复原来的走路、跑步或下蹲动作。", ["lateral-chain", "popliteus"]),
    ...
    },
    {
      ...
      candidates: [
        candidate("knee-extension-muscles", "大腿外侧与后侧候选", "muscle", "self", "只处理检查中明确更紧或更酸的一处：大腿外侧、大腿后侧或小腿后侧，轻柔松解60～90秒。", "避开腘窝正中和明显刺痛点；其他相关区域只保留为候选，不默认全部处理。", "重新比较膝盖伸直和原来的不适动作。", ["extension", "posterior-chain", "lateral-chain"], { retestIds: ["knee-extension"] }),
        candidate("knee-extension-anterior-muscles", "大腿前侧与股直肌轻柔松解", "muscle", "self", "如果大腿前侧比另一侧更紧或更酸，轻柔放松大腿前侧与股直肌周围60～90秒。", "避开髌骨、髌腱和明确刺痛点；没有前侧紧张差别时不做这一项。", "重新比较膝盖伸直和原来的不适动作。", ["extension", "quadriceps", "rectus-femoris", "anterior-knee"], { retestIds: ["knee-extension"], siteLabel: "大腿前侧", targetLabel: "股直肌与股四头肌前侧", actionLabel: "大腿前侧轻柔松解" }),
        candidate("knee-extension-anterior-lateral", "大腿前侧与外侧链轻柔松解", "muscle", "self", "处理检查中明确紧张的股直肌、大腿前侧或外侧链区域，每处60～90秒。", "避开髌骨、髌腱和明确刺痛点，不沿髂胫束整条重压。", "统一比较膝盖伸直和原来的不适动作。", ["extension", "quadriceps", "rectus-femoris", "lateral-chain"], { retestIds: ["knee-extension"], siteLabel: "大腿前侧与外侧链", targetLabel: "股直肌、股四头肌前侧与外侧链", actionLabel: "大腿前侧与外侧链轻柔松解" }),
        candidate("knee-extension-anterior-lower-leg", "小腿前侧肌群轻柔松解", "muscle", "self", "如果检查时发现小腿前侧比另一边更紧或更酸，轻柔松解胫骨前肌与趾伸肌周围60～90秒。", "避开胫骨骨面和明确刺痛点；没有紧张差别时不做这一项。", "重新比较膝盖伸直和原来的不适动作。", ["extension", "tibialis-anterior", "toe-extensor"], { retestIds: ["knee-extension"], siteLabel: "小腿前侧肌群", targetLabel: "胫骨前肌与趾伸肌周围", actionLabel: "小腿前侧肌群轻柔松解" }),
        ...
        candidate("knee-extension-control", "训练股四头末端控制", "control", "self", "仰卧，腿伸直，绷紧大腿前侧做膝后下压，压到最直的位置停2秒，做6～10次。", "主动范围逐渐追上被动，不靠髋抬起代偿。", "复测站立伸膝与步态，力量留待后续复查。", ["quad", "terminal-extension"]),
      ],
    },
    {
  ...
  exercises: [
    exercise("knee-heel-slide-quad-set", "膝盖弯曲和伸直训练", 1, "3组", "每项每组10个", "仰卧，脚跟贴床慢慢弯膝盖，弯到发紧处停10～15秒再放回；然后腿伸直，绷紧大腿把膝后压向床面，保持5秒后放松。", "停在发紧的位置时不出现锐痛；膝后下压时大腿前侧能真正绷起来，臀部不会不自觉抬起。", "减小滑动范围，膝后下压保持3秒。", "在伸膝末端加上弹力带抗阻。", ["knee-rom", "quad-activation", "quadriceps", "terminal-extension"], "弯曲靠“滑到紧处停住”一点点找回来；膝后下压练的是“绷直”这个开关——肿痛时大腿常常想绷绷不上，开关不修好，后面的力量练习都白练。"),
    ...
    exercise("knee-standing-hip-flexion", "站立屈髋（臀部向后）", 3, "3组", "每组10个", "背对墙站立约一脚距离，膝盖微屈，臀部向后移动轻碰墙面，身体从髋部向前折叠，再用臀腿站起；熟练后离开墙面做。", "髋膝踝方向一致，脚掌稳定，腰部不抢先弯曲；碰不到墙或腰先酸了，说明动作做成了弯腰。", "减小臀部向后幅度，扶支撑。", "增加折髋范围、轻负重或改单腿。", ["hip-hinge", "movement-pattern", "standing-hip-flexion", "stairs", "glute"], "练“用髋不用膝”的动作模式——捡东西、坐下、下楼都靠它；碰墙是唯一能自己验证的反馈，膝盖疼的人最该重新学会。"),
    ...
    exercise("knee-drop-landing", "低台阶踏下停 2 秒", 4, "3组", "每侧每组8个", "站在低台阶上，患侧脚慢慢踏下落地，膝盖微弯缓冲，落地后定住2秒不动，再借双脚帮助回到台阶。", "膝盖不往内扣，落地轻没有“咚”的一声；出现锐痛或打软就退回台阶练习。", "先在平地上练双脚缓冲屈膝落地。", "增加台阶高度，或改为向前一步落地。", ["landing", "single-leg", "deceleration", "control"], "跳之前先学会落地那一下的“刹车”。从台阶踏下来是冲击最小、最稳的落地练法，定得住才有资格练跳。"),
    ...
    exercise("knee-jump-decelerate", "跳跃落地与减速", 5, "4组", "每组5个", "从双脚小跳落地开始，进阶到前向落地、单脚和变向。", "髋膝踝共同缓冲，每次落地都能稳定停住。", "退回低台阶踏下停 2 秒或快速踮脚尖。", "增加高度、速度、方向或专项组合。", ["jump", "landing", "change-direction"], "跳回来的关键不是跳多高，而是落地那一下膝盖不内扣、稳得住。先练“落地刹车”。"),
  ],
};
...
const ankleFoot: FullRegion = {
  ...
  strengths: [
    strength("ankle-dorsiflexor", assessmentPro("ankle-dorsiflexor").title, assessmentPro("ankle-dorsiflexor").how, assessmentPro("ankle-dorsiflexor").observe, ["tibialis-anterior", "dorsiflexion"]),
    strength("ankle-evertor", assessmentPro("ankle-evertor").title, assessmentPro("ankle-evertor").how, assessmentPro("ankle-evertor").observe, ["peroneal", "eversion"]),
    strength("ankle-invertor", assessmentPro("ankle-invertor").title, assessmentPro("ankle-invertor").how, assessmentPro("ankle-invertor").observe, ["tibialis-posterior", "inversion", "arch"]),
    ...
    strength("ankle-intrinsic", assessmentPro("ankle-intrinsic").title, assessmentPro("ankle-intrinsic").how, assessmentPro("ankle-intrinsic").observe, ["foot-intrinsic", "arch"]),
  ],
  functions: [
  ...
  candidateGroups: [
    {
      ...
      candidates: [
        candidate("ankle-calf-anterior-local", "小腿前侧肌群", "muscle", "self", "检查支持小腿前侧时，轻柔松解胫骨前肌或趾伸肌周围60～90秒。", "避开胫骨骨面和明确刺痛点；力量偏弱时仍需安排勾脚控制。", "复测原来的勾脚、走路或发力动作。", ["tibialis-anterior", "toe-extensor", "dorsiflexion"], { retestIds: ["ankle-dorsiflexion"], siteLabel: "小腿前侧肌群", targetLabel: "胫骨前肌与趾伸肌群", actionLabel: "小腿前侧肌群轻柔松解" }),
        candidate("ankle-calf-lateral-local", "小腿外侧肌群", "muscle", "self", "检查支持小腿外侧时，轻柔松解腓骨肌周围60～90秒。", "避开腓骨骨面和明确刺痛点；力量偏弱时仍需安排外翻控制。", "复测原来的外翻、走路或发力动作。", ["peroneal", "eversion"], { retestIds: ["ankle-eversion"], siteLabel: "小腿外侧肌群", targetLabel: "腓骨肌群", actionLabel: "小腿外侧肌群轻柔松解" }),
    ...
    },
    {
      ...
      candidates: [
        ...
        candidate("ankle-lateral-anterior-muscles", "小腿前侧肌群", "muscle", "self", "如果检查发现小腿前侧更紧或更酸，轻柔松解胫骨前肌或趾伸肌周围60～90秒。", "避开胫骨骨面、肿胀中心和明确刺痛点。", "复测仍未恢复的勾脚和原来的不适动作。", ["tibialis-anterior", "toe-extensor", "dorsiflexion"], { retestIds: ["ankle-dorsiflexion"], siteLabel: "小腿前侧肌群", targetLabel: "胫骨前肌与趾伸肌群", actionLabel: "小腿前侧肌群轻柔松解" }),
        candidate("ankle-lateral-peroneal-muscles", "小腿外侧肌群", "muscle", "self", "如果检查发现小腿外侧更紧或更酸，轻柔松解腓骨肌周围60～90秒。", "避开腓骨骨面、肿胀中心和明确刺痛点。", "复测仍未恢复的外翻和原来的不适动作。", ["peroneal", "eversion"], { retestIds: ["ankle-eversion"], siteLabel: "小腿外侧肌群", targetLabel: "腓骨肌群", actionLabel: "小腿外侧肌群轻柔松解" }),
        ...
        candidate("ankle-lateral-control", "训练外翻与足弓控制", "control", "self", "在不太疼的范围做脚掌向外转，再做 5～8 次重心前后转移；单腿站时脚掌踩实、内侧别塌。", "膝与脚尖方向自然，脚趾不抓地。", "复测走路和单腿站；力量留待后续。", ["eversion", "arch", "weight-shift"]),
      ],
    },
    {
    ...
    },
    {
      ...
      candidates: [
        candidate("ankle-df-muscles", "小腿后侧轻柔松解", "muscle", "self", "用手或泡沫轴轻柔放松小腿后侧，每个紧张区域60～90秒。", "不要持续重压踝前刺痛点。", "重新比较勾脚和原来的不适动作。", ["dorsiflexion", "calf", "posterior-chain"]),
    ...
    },
    {
      ...
      candidates: [
        candidate("ankle-achilles-muscles", "小腿后侧轻柔松解", "muscle", "self", "用手或泡沫轴轻柔放松小腿肌肉，每个紧张区域60～90秒。", "不压跟腱疼痛点，不做强力拉伸。", "重新比较固定个数提踵或原来的走路动作。", ["calf", "achilles", "dorsiflexion"]),
    ...
    },
    {
      ...
      candidates: [
        candidate("ankle-plantar-muscles", "足底与足弓轻柔松解", "muscle", "self", "用软球轻滚足底和足弓周围，每个区域60～90秒。", "避开足跟刺痛点，不反复重压。", "重新比较走路或提踵；晨起反应第二天再记录。", ["plantar", "great-toe"]),
        ...
        candidate("ankle-plantar-control", "足弓与走路推蹬练习", "control", "self", "坐着，脚趾抓毛巾 5 次；再慢走一小段，感受脚跟着地到前脚掌推地。", "脚趾不抓地，步幅保持自然。", "重新比较原来的走路或提踵动作。", ["arch", "gait", "push-off"]),
      ],
    },
  ],
  exercises: [
