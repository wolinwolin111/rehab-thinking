...
export const THIGH_LOCAL_REGION: FullRegion = {
  ...
  exercises: [
    ...
    exercise("thigh-back-isometric", "大腿后侧等长保持（脚跟轻拉地面）", 1, "2组", "每组5次，每次5秒", "坐稳，脚跟踩地，像要把脚跟拖向椅子下方，但脚不要真的移动。", "大腿后侧均匀发力，不抽筋。", "减小用力或保持3秒。", "增加到每组8次。", ["thigh-back", "hamstring", "isometric"], "坐位", "大腿后侧参与稳住膝盖；坐着绷住不动，是拉伤后最安全的不牵拉发力。"),
...
export const CALF_LOCAL_REGION: FullRegion = {
  ...
  exercises: [
    ...
    exercise("calf-medial-arch", "足弓保持与提踵", 2, "3组", "每组8～10个", "站稳，脚趾放松贴地，想象大脚趾根轻轻向脚跟收短、足弓鼓起，保持住再做小幅提踵。", "脚趾不抠地，脚跟不向外甩，小腿不跟着转。", "只练收短足弓保持2秒。", "增加提踵高度。", ["calf-medial", "arch", "heel-raise"], "站立", "足弓是弹簧的地脚；撑住它再提踵，力量才不从小腿内侧漏掉。"),
