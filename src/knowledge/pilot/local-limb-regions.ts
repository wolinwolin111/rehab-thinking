...
export const CALF_LOCAL_REGION: FullRegion = {
  ...
  exercises: [
    ...
    exercise("calf-medial-arch", "足弓保持与提踵", 2, "3组", "每组8～10个", "站稳，脚趾放松贴地，轻轻踮起脚尖再放下，做2组，每组6～8次。", "脚趾不抠地，脚跟不向外甩，小腿不跟着转。", "扶着墙做，只抬一点点。", "增加提踵高度。", ["calf-medial", "arch", "heel-raise"], "站立", "小腿内侧和足弓一起练回来，走路时力量才不从小腿内侧漏掉。"),
