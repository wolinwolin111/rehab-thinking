...
export const PILOT_RELATIONS: PilotRelation[] = [
  {
    ...
    trainingIds: ["thigh-local-isometric", "thigh-sit-stand"], evidence: "P1", status: "reviewed-source", sourceCases: ["线下记录：股直肌与股四头肌候选", "独立局部流程规则"],
  },
  {
    ...
    trainingIds: ["thigh-local-isometric", "thigh-bridge"], evidence: "P2", status: "reviewed-source", sourceCases: ["线下记录：腘绳肌处理与臀桥进阶", "Hamstring CPG 2022"],
  },
  {
    ...
    trainingIds: ["thigh-local-isometric", "thigh-sit-stand"], evidence: "P1", status: "reviewed-source", sourceCases: ["线下记录：内收肌候选", "独立局部流程规则"],
  },
  {
    ...
    trainingIds: ["thigh-local-isometric", "thigh-sit-stand"], evidence: "P2", status: "reviewed-source", sourceCases: ["线下记录：阔筋膜张肌、股外侧肌与髋外侧控制", "独立局部流程规则"],
  },
  {
    ...
    trainingIds: ["calf-local-control", "calf-gait"], evidence: "P2", status: "reviewed-source", sourceCases: ["线下记录：胫骨前肌与趾伸肌候选", "独立局部流程规则"],
  },
  {
    ...
    trainingIds: ["calf-local-control", "calf-heel-raise-progress", "calf-gait"], evidence: "P1", status: "reviewed-source", sourceCases: ["线下记录：腓肠肌、比目鱼肌候选", "小腿拉伤分期负荷原则"],
  },
  {
    ...
    trainingIds: ["calf-local-control", "calf-gait"], evidence: "P2", status: "reviewed-source", sourceCases: ["线下记录：胫骨后肌候选", "独立局部流程规则"],
  },
  {
    ...
    trainingIds: ["calf-local-control", "calf-gait"], evidence: "P2", status: "reviewed-source", sourceCases: ["线下记录：腓骨肌与大腿外侧链反应候选", "独立局部流程规则"],
  },
  {
    id: "KNEE-R01",
    regionId: "knee",
  ...
  },
  {
    ...
    treatmentCandidates: [
      treatment("knee-fibula-combination", "joint", "腓骨近端与远端", "分步检查腓骨近端和远端活动，不同时归因", ["function:knee-squat"]),
    ],
    trainingIds: [],
    evidence: "P1",
    status: "reviewed-source",
