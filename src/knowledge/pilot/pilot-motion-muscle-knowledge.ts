...
const PROFESSIONAL_ASSESSMENT_TITLES: Record<string, string> = {
  ...
  "thigh-lateral-load": "大腿外侧肌群拉长检查（跨体内收）",
  ...
  "calf-dorsiflexion": "踝背屈检查（小腿前侧缩短与小腿后侧拉长）",
  "calf-plantarflexion": "踝跖屈检查（小腿后侧缩短与小腿前侧拉长）",
  "calf-inversion": "踝内翻检查（小腿内侧缩短与小腿外侧拉长）",
  "calf-eversion": "踝外翻检查（小腿外侧缩短与小腿内侧拉长）",
