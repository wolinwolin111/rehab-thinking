...
export const COMPENSATION_OPTIONS: Record<string, CompensationOption> = {
  ...
  "knee-inward": { label: { plain: "膝盖向内偏", pro: "膝内偏" }, legacy: ["膝盖向内偏"], tags: ["adductor", "hip-abduction", "glute-med"] },
  "land-knee-inward": { label: { plain: "落地时膝盖明显向内偏", pro: "落地膝内偏" }, legacy: ["落地时膝盖明显内扣"], tags: ["adductor", "hip-abduction", "glute-med"] },
  "heel-early-rise": { label: { plain: "脚跟提前抬起", pro: "足跟提前离地" }, legacy: ["脚跟提前抬起"], tags: ["dorsiflexion"] },
  "body-sway": { label: { plain: "身体明显晃动", pro: "躯干摇摆" }, legacy: ["身体明显晃动"], tags: ["hip-abduction", "glute-med", "hip-control", "foot-support"] },
  "side-balance-worse": { label: { plain: "一侧明显比另一侧更难站稳", pro: "一侧平衡明显更差" }, legacy: ["不舒服的那边明显更难站稳", "不舒服的一侧更难站稳"], tags: ["hip-abduction", "glute-med", "hip-control", "foot-support"] },
  "pelvis-tilt": { label: { plain: "骨盆明显歪向一边", pro: "骨盆侧倾" }, legacy: ["骨盆明显歪斜"], tags: ["hip-abduction", "glute-med", "hip-control", "foot-support"] },
  ...
  "body-or-pelvis-lean": { label: { plain: "身体或骨盆歪向一边", pro: "躯干或骨盆侧偏" }, legacy: ["身体或骨盆歪向一边"], tags: ["hip-abduction", "glute-med", "hip-control", "foot-support"] },
  "descent-give-way": { label: { plain: "下降时突然掉下去", pro: "下降期打软" }, legacy: ["下降时突然掉下去"], tags: ["quadriceps"] },
  ...
  "trunk-fwd-lean": { label: { plain: "身体明显向前倾", pro: "躯干前倾代偿" }, legacy: [], tags: ["hamstring", "posterior-chain"] },
  "trunk-side-lean": { label: { plain: "身体明显向一边倒", pro: "躯干侧倒代偿" }, legacy: [], tags: ["hip-abduction", "glute-med", "hip-control", "foot-support"] },
  "push-off-opposite-leg": { label: { plain: "主要靠另一条腿蹬起", pro: "对侧蹬地主导" }, legacy: ["主要靠另一条腿蹬起"], tags: ["quadriceps"] },
  ...
  "limp-gait": { label: { plain: "走路明显一瘸一拐", pro: "跛行步态" }, legacy: ["走路明显一瘸一拐", "迈步时跛行"], tags: ["gait"] },
  ...
  "stride-short": { label: { plain: "脚步明显变短", pro: "步幅缩短" }, legacy: ["脚步明显变短", "步幅明显变短"], tags: ["gait"] },
  "ankle-in-or-out-wobble": { label: { plain: "脚踝向内或向外晃", pro: "踝内外摆动" }, legacy: ["脚踝向内或向外晃", "脚踝反复向内或向外晃"], tags: ["inversion", "eversion"] },
  ...
  "stance-time-short": { label: { plain: "不舒服的那条腿踩地时间变短", pro: "患侧支撑时相缩短" }, legacy: ["患侧支撑时间变短"], tags: ["gait"] },
  "body-lean-side": { label: { plain: "身体向一侧偏", pro: "躯干侧偏" }, legacy: ["身体向一侧偏"], tags: ["hip-abduction", "glute-med"] },
  "push-off-pain": { label: { plain: "蹬地的时候明显不舒服", pro: "蹬地期疼痛" }, legacy: ["蹬地时症状明显"] },
  "lean-to-opposite": { label: { plain: "起身时身体歪向另一侧", pro: "起立对侧偏倚" }, legacy: ["起身时偏向另一侧"], tags: ["quadriceps"] },
  "need-hand-push": { label: { plain: "需要用手撑", pro: "需手撑辅助" }, legacy: ["需要用手撑"] },
  "sit-drop": { label: { plain: "坐下时突然掉下去", pro: "坐落期塌陷" }, legacy: ["坐下时突然掉下去"], tags: ["quadriceps"] },
  "body-side-fall": { label: { plain: "身体明显侧倒", pro: "躯干侧倒" }, legacy: ["身体明显侧倒"], tags: ["hip-abduction", "glute-med"] },
  ...
  "heel-strike-unstable": { label: { plain: "脚跟落地不稳", pro: "足跟着地不稳" }, legacy: ["脚跟落地不稳"], tags: ["dorsiflexion"] },
  ...
  return text.includes("膝盖明显向内")
    ...
    : text.includes("脚跟提前") || text.includes("膝盖高度")
      ...
      : text.includes("晃动") || text.includes("站稳")
        ? ["hip-abduction", "glute-med", "hip-control", "foot-support"]
        : text.includes("抬起高度")
          ? ["heel-raise", "calf"]
          : [];
}
