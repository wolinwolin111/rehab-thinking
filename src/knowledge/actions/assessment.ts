...
export const ASSESSMENT_ENTRIES: AssessmentEntry[] = [
  ...
  },
  {
    ...
    bilateralObserve: { plain: "能不能连续完成10次标准提踵，不靠脚趾抓地？", pro: "能不能连续完成10次标准提踵，不靠脚趾抓地？" },
    optionSet: "strength",
    options: STRENGTH_HEEL,
    dose: { plain: { both: 10 }, pro: { both: 10, each: 10 } },
  },
  ...
  },
  {
    ...
    bilateralObserve: { plain: "两侧分别绷直膝盖，记录哪一侧更难压平或更不舒服。", pro: "两侧分别绷直膝盖，记录哪一侧更难压平或更不舒服。" },
  ...
  },
  {
    ...
    bilateralObserve: { plain: "两侧分别弯膝，记录哪一侧更难靠近臀部或更不舒服。", pro: "两侧分别弯膝，记录哪一侧更难靠近臀部或更不舒服。" },
    optionSet: "direction", dose: { plain: {}, pro: {} },
  },
  {
  ...
  },
  {
    ...
    bilateralObserve: { plain: "脚背能不能明显靠近小腿？注意看脚背，不要只把脚尖勾起来。", pro: "脚背能不能明显靠近小腿？注意看脚背，不要只把脚尖勾起来。" },
    optionSet: "direction", dose: { plain: {}, pro: {} },
  },
  {
  ...
  },
  {
    ...
    bilateralObserve: { plain: "脚背能不能向下压到接近和小腿平直？", pro: "脚背能不能向下压到接近和小腿平直？" },
    optionSet: "direction", dose: { plain: {}, pro: {} },
  },
  {
    ...
    bilateralObserve: { plain: "两只脚分别向内转，记录哪一侧范围更小或更不舒服。", pro: "两只脚分别向内转，记录哪一侧范围更小或更不舒服。" },
    optionSet: "direction", dose: { plain: {}, pro: {} },
  },
  {
    ...
    bilateralObserve: { plain: "两只脚分别向外转，记录哪一侧范围更小或更不舒服。", pro: "两只脚分别向外转，记录哪一侧范围更小或更不舒服。" },
    optionSet: "direction", dose: { plain: {}, pro: {} },
  },
  {
  ...
  },
  {
    ...
    bilateralObserve: { plain: "两侧分别绷紧大腿保持5秒，记录哪一侧更容易抖或掉力。", pro: "两侧分别绷紧大腿保持5秒，记录哪一侧更容易抖或掉力。" },
  ...
  },
  {
    ...
    bilateralObserve: { plain: "两侧分别保持勾脚5秒，观察哪一侧更快掉下来或需要脚趾代偿。", pro: "两侧分别保持勾脚5秒，观察哪一侧更快掉下来或需要脚趾代偿。" },
    optionSet: "strength", dose: { plain: { hold: 5 }, pro: { hold: 5 } },
  },
  {
