...
export const GENERIC_REGISTRY: Record<string, string> = {
  ...
  "symptom-types": "症状性质多选（酸/胀/刺/麻/电…），性质词汇不随动作变化——C3 登记 2026-09-05",
  "safety-items": "安全信号清单（错位/血管/神经/发热/血栓），安全语义不随动作变化——C3 登记 2026-09-05",
  "goals": "恢复目标五级（self/pro 双域），已是常量＋渲染处选择的双层结构——C3 登记 2026-09-05",
  "prior-care-options": "症状收集页：既往处理事实，与动作无关——C3 登记 2026-09-05",
  "onsets": "症状收集页：起病时间分类，与动作无关——C3 登记 2026-09-05",
  "mechanisms": "症状收集页：受伤机制分类，与动作无关——C3 登记 2026-09-05",
  "provocation-types": "症状收集页：诱发因素分类，与动作无关——C3 登记 2026-09-05",
  "patella-direction-labels": "髌骨四方向卡片简称＋标题附属小标签，正式标题已由目录覆盖——C3 登记 2026-09-05",
};
