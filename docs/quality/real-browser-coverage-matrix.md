...
| UX-02 | 案例学习和学习解释入口能真实打开 | 首页进入案例学习并切换解释 | 8.27 裁定：案例学习关闭，入口不可达为验收标准 | 按裁定关闭 | 8.27 裁定入口不可达为验收通过标准，不再作为功能缺口；未实现即符合预期（closed by decision） |
...
- `UX-02`：案例学习关闭 — 8.27 裁定入口不可达为验收标准，按裁定关闭（closed by decision）；
