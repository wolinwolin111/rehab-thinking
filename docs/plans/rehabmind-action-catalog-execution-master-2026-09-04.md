...
| C1-1 | 代偿 48 组迁目录 | **已做·缩减 20/48**（dd10806）。缩减原因：28 键的评估条目未入库（颈/肩/胸/肘/腕/腰/髋＋custom-action/ankle-knee-wall/thigh-bridge-check）——三层降级（目录→旧表→通用）保行为；52 键新旧输出逐字相同 |
...
| — | 全程验收 | 每步失败集合与基线逐条相同（53 条＝52 预存＋1 批次 2 problem-ledger-core 待测试侧）；check:catalog/typecheck 全绿 |
